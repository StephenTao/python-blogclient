...
class HTTPClient(object):
    ...
    def get(self, url, headers=None):
        ...
        self._print_request_info(url, headers=headers)
    ...
    def post(self, url, body, headers=None):
        ...
        self._print_request_info(url, body, headers)
    ...
    def _print_request_info(self, url, body=None, headers=None):
        print '---- request info ----'
        print '[requestion url]:' + self.base_url + url
        print '[request body]:'
        print body
        print "[request headers]:"
        print headers
        print '---- end requestion info ----'
